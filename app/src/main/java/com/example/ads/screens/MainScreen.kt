...
fun BottomNavigationBar() {
    BottomAppBar {
        ...
        Column(
            ...
            IconButton(onClick = { /* Действие для кнопки "Мой профиль" */ }) {
...
@Composable
fun NewADS(modifier: Modifier = Modifier) {
    Button(onClick = { /* Действие при нажатии на кнопку */ }, modifier = modifier) {
